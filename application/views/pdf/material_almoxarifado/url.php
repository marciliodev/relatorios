...
<body onLoad="$('#modalInfo').modal('show');">
    ...
    <div class="container">
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalAlmoxarifado">
            Consultar
        </button>

        <!-- Modal -->
        <div class="modal fade" id="modalAlmoxarifado" tabindex="-1" role="dialog" aria-labelledby="modalAlmoxarifadoLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalAlmoxarifadoLabel"><?=@$tituloModal?></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                   <?=@$this->load->view('pdf/material_almoxarifado/body', '', TRUE)?>
                </div>
                    <div class="modal-footer">
                        <?=@$impressaoPDF?>
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
